...
var sliderInfo = [
    ...
    { imgSrc: `${pluginUrl}img/videos/video5.webp`, img: 'Video 5', content:'Al seguir desmontando tus creencias limitantes lograrás hacer quirúrgicas posibilidades donde antes habían barreras, podrás conectar con tu verdadero propósito y elevar tu nivel de energía para conectar con altos niveles de intención.'},
...
<div id="carouselControls" class="carousel slide d-md-block d-none" data-pause data-aos="fade-zoom-in" data-aos-duration="1500">
    ...
    <a rel="nofollow noopener noreferrer" class="carousel-control-prev" href="#carouselControls" role="button" data-slide="prev"> 
        <span class="carousel-control-prev-icon" aria-hidden="true"></span> 
        <span class="sr-only">Previous</span> 
    </a> 
    <a rel="nofollow noopener noreferrer" class="carousel-control-next" href="#carouselControls" role="button" data-slide="next"> 
...
<div id="carouselControlsMovil" class="carousel slide d-md-none d-block" data-pause data-aos="fade-zoom-in" data-aos-duration="1500"> 
    ...
    <a rel="nofollow noopener noreferrer" class="carousel-control-prev" href="#carouselControlsMovil" role="button" data-slide="prev"> 
        <span class="carousel-control-prev-icon" aria-hidden="true"></span> 
        <span class="sr-only">Previous</span> 
    </a> 
    <a rel="nofollow noopener noreferrer" class="carousel-control-next" href="#carouselControlsMovil" role="button" data-slide="next"> 
        <span class="carousel-control-next-icon" aria-hidden="true"></span> 
        <span class="sr-only">Next</span> 
    </a> 
</div>`;
...
var testimonios = [
    ...
    { video:'https://player.vimeo.com/video/353454359?color=4B314C', imagen: `${pluginUrl}/img/200/alejandro-perez.webp`, nombre: 'Alejandro Peréz Bolaños', content: 'Quiero comentarte que tenemos una nueva certificación con ILC Academy. Tengo 20 años trabajando como coach, he pasado por muchas escuelas y creo que en ILC Academy encuentras el equilibrio para formarte como un coach integral' }, 
    ...
    testimoniosHtml += `
        <div class="carousel-item active"> 
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-10"> 
                        <img src="${testimonios[0].imagen}" alt="${testimonios[0].nombre} Testimonio" data-video="${testimonios[0].video}" class="modalImg img-fluid rounded-circle mx-auto mb-3 cursor-pointer" data-toggle="modal" data-target="#testimonioModal">
                        <h2 class="text-light">${testimonios[0].nombre}</h2>
                        <p class="pTestimonio">${testimonios[0].content}</p>
                    </div>
                </div>
            </div>
        </div>`; 
        ...
        <div class="carousel-item "> 
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-10"> 
                        <img src="${testimonios[i].imagen}" alt="${testimonios[i].nombre}" data-video="${testimonios[i].video}" class="modalImg img-fluid rounded-circle mx-auto mb-3 cursor-pointer" data-toggle="modal" data-target="#testimonioModal">
                        <h2 class="text-light">${testimonios[i].nombre}</h2>
                        <p class="pTestimonio">${testimonios[i].content}</p>
                    </div>
                </div>
            </div>
        </div>`;
...
$('#testimonios').append(testimoniosHtml);
/*Funcion para cambiar video de personas*/
$('.modalImg').click(function(){
    var video = $(this).data('video');
    $(".modal-body .embed-responsive").html(`<iframe src="${video}" frameborder="0" allow="autoplay; fullscreen" allowfullscreen=""></iframe>`);
});
//Al cerrar modal, eliminar video
...
var coaches = [
    ...
    { imagen: `${pluginUrl}/img/200/sandra-rawson.webp`, nombre: 'Sandra Rawson', content: 'Buscar la mejor versión personal es una camino que requiere ayuda. Desde la confianza y sobre todo desde el amor, me comprometo a darte herramientas poderosas para que conquistes este proceso' },
	];
